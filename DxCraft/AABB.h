...
public:
	...
	static float hitbox_x_depth(const AABB& obj1, const AABB& obj2, float eps = 0.00128f);
	static float hitbox_y_depth(const AABB& obj1, const AABB& obj2, float eps = 0.00128f);
	static float hitbox_z_depth(const AABB& obj1, const AABB& obj2, float eps = 0.00128f);
};
